    ...
    return(
      <div className="bg-secondary flex-1 rounded-md py-5 px-4 flex items-center gap-x-4">
        <div className="relative md:w-44 md:h-44 w-36 h-36 after:content-[``] border[5px] border-primary rounded-full overflow-hidden">
            <Image src="/images/bg.jpg" alt="" layout="fill" className="hover:scale-105 transition-all" objectFit="cover"></Image>
        </div>
...
const Campaigns = () => {
  return (
    <div className="relative flex justify-between container mx-auto py-20 gap-6 flex-wrap">
        <CampaignItem />
        <CampaignItem />
    </div>
  )
